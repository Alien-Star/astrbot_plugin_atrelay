📬 艾特群友转发
<p align="center">
<img src="https://img.shields.io/badge/version-1.1.0-blue.svg" alt="版本">
...
<div style="font-weight: 600; margin-bottom: 4px;">自然语言</div>
<div style="font-size: 14px; color: #57606a;">支持群名/昵称识别，无需记群号</div>
</td>
</tr>
</table>
📖 使用方法
...
💡 说明：[@用户] 为可选参数，不填则只发消息不艾特<br>
💡 新版支持自然语言：直接说“去XX群告诉YY晚安”即可自动识别
</div>
</div>
🎯 实际例子
...
<td style="padding: 10px;"><code>试一下帮我去群123456789里告诉群主，让他也早点睡</code></td>
<td style="padding: 10px;">➡️ 在群 <code>123456789</code> 中 <code>@1347536076</code> 并发送「早点休息吧，万华镜的光都快熄了。」</td>
</tr>
<tr style="border-bottom: 1px solid #e1e4e8;">
...
<tr style="border-bottom: 1px solid #e1e4e8;">
<td style="padding: 10px;"><code>去“摸鱼交流群”告诉“小明”记得开会</code></td>
<td style="padding: 10px;">➡️ 自动匹配群号+QQ号，精准艾特发送</td>
</tr>
</tbody>
</table>
🎯 适用场景
...
<li style="margin-bottom: 12px; padding: 8px 12px; background: #f6f8fa; border-radius: 8px; border: 1px solid #e1e4e8;">
<span style="font-weight: 600;">💬 私聊推送</span> — 支持机器人主动向指定QQ发送私聊消息
</li>
<li style="margin-bottom: 12px; padding: 8px 12px; background: #f6f8fa; border-radius: 8px; border: 1px solid #e1e4e8;">
<span style="font-weight: 600;">🗣️ 自然交互</span> — 不用记群号/QQ号，群名昵称直接使用
</li>
</ul>
⚠️ 注意事项
...
<td style="padding: 8px;">仅支持QQ群/QQ私聊</td>
</tr>
</table>
</div>
📦 安装方式
...
<tbody>
<tr style="border-bottom: 1px solid #e1e4e8;">
<td style="padding: 8px;"><code>v1.1.0</code></td>
<td style="padding: 8px;">🆕 新增私聊发送、群名/昵称匹配工具；支持自然语言调用；修复int群号判断bug</td>
</tr>
<tr style="border-bottom: 1px solid #e1e4e8;">
